...
<!-- MAIN HEADING -->
  ...
  <h3><b>Greetings Rails project Back-end</b></h3>
...
<!-- INTRO -->
# 📖 Greetings Rails project Back-end <a name="about-project"></a>

> Greetings Rails project Back-end is the backend of a fun meet and greet project that uses both Rails backend and React with Webpack frontend. If you want to have endless greetings, here is your friend.
...
https://github.com/leloufadel/hello-rails-backend.git
```
...
- GitHub: [@anyars-encarta](https://github.com/leloufadel)
- Twitter: [@anyarsencarta](https://twitter.com/lelouadel)
